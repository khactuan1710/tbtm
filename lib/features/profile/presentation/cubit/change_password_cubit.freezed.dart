...
mixin _$ChangePasswordState {
 ...
 bool get isSubmitting; bool get didSucceed;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangePasswordState&&(identical(other.isSubmitting, isSubmitting) || other.isSubmitting == isSubmitting)&&(identical(other.didSucceed, didSucceed) || other.didSucceed == didSucceed));
}


@override
int get hashCode => Object.hash(runtimeType,isSubmitting,didSucceed);

@override
String toString() {
  return 'ChangePasswordState(isSubmitting: $isSubmitting, didSucceed: $didSucceed)';
}
...
@useResult
$Res call({
 bool isSubmitting, bool didSucceed
});
...
/// Create a copy of ChangePasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isSubmitting = null,Object? didSucceed = null,}) {
  return _then(_self.copyWith(
isSubmitting: null == isSubmitting ? _self.isSubmitting : isSubmitting // ignore: cast_nullable_to_non_nullable
as bool,didSucceed: null == didSucceed ? _self.didSucceed : didSucceed // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isSubmitting,  bool didSucceed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChangePasswordState() when $default != null:
return $default(_that.isSubmitting,_that.didSucceed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isSubmitting,  bool didSucceed)  $default,) {final _that = this;
switch (_that) {
case _ChangePasswordState():
return $default(_that.isSubmitting,_that.didSucceed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isSubmitting,  bool didSucceed)?  $default,) {final _that = this;
switch (_that) {
case _ChangePasswordState() when $default != null:
return $default(_that.isSubmitting,_that.didSucceed);case _:
  return null;
...
class _ChangePasswordState extends ChangePasswordState {
  const _ChangePasswordState({this.isSubmitting = false, this.didSucceed = false}): super._();
  

@override@JsonKey() final  bool isSubmitting;
@override@JsonKey() final  bool didSucceed;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChangePasswordState&&(identical(other.isSubmitting, isSubmitting) || other.isSubmitting == isSubmitting)&&(identical(other.didSucceed, didSucceed) || other.didSucceed == didSucceed));
}
...
/// Create a copy of ChangePasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isSubmitting = null,Object? didSucceed = null,}) {
